...
class Country
{
    ...
    #[ORM\OneToMany(mappedBy: 'country', targetEntity: Evenement::class, cascade: ['persist', 'remove'])]
    ...
    public function removeEvenement(Evenement $evenement): static
    {
        if ($this->evenements->removeElement($evenement)) {
            ...
            if ($evenement->getCountry() === $this) {
                $evenement->setCountry(null);
            }
        }
