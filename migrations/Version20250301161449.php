 ...
 */
final class Version20250301161449 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, offre_id INT NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, email VARCHAR(100) NOT NULL, telephone VARCHAR(20) DEFAULT NULL, ville VARCHAR(50) NOT NULL, nombre_personne INT NOT NULL, date_depart DATE DEFAULT NULL, heure_depart TIME DEFAULT NULL, type_voyage VARCHAR(255) DEFAULT NULL, mode_paiement VARCHAR(255) NOT NULL, preferences_voyage JSON DEFAULT NULL, regime_alimentaire VARCHAR(255) DEFAULT NULL, commentaire LONGTEXT DEFAULT NULL, date_reservation DATETIME NOT NULL, statut VARCHAR(20) NOT NULL, date_paiement DATETIME DEFAULT NULL, stripe_payment_id VARCHAR(255) DEFAULT NULL, INDEX IDX_42C849554CC8505A (offre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
